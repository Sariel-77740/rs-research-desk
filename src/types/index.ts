...
export interface Paper { id: string; title: string; authors: string; year: number; venue: string; tags: string[]; status: PaperStatus; rating: number; progress: number; importance: "high" | "medium" | "low"; abstract: string; }
